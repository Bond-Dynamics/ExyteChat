...
extension MessageView {
    ...
    @ViewBuilder
    func reactionsView(_ message: any MessageProtocol, maxReactions: Int = 5) -> some View {
    ...
    private func prepareReactions(message: any MessageProtocol, maxReactions:Int) -> PreparedReactions {
